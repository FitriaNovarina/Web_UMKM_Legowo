...
const HomePageClient = ({ initialProducts, fetchError }: { initialProducts: ProductCardType[], fetchError: boolean }) => {
  const { t, language } = useLanguage();
  
  const [featuredProducts, setFeaturedProducts] = useState<ProductCardType[]>(initialProducts);
  ...
  // Fetching logic removed as it's now handled by the Server Component
  ...
  // Loading skeleton removed, Server Component provides initial payload
